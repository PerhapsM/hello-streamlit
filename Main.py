...
st.write("Get start with Streamlit template from https://share.streamlit.io/new/deploy-from-template")

st.divider()
# ----------------------------------------------------------------------------------------------------------------------
st.header("Started with Streamlit")
# ----------------------------------------------------------------------------------------------------------------------

st.subheader(" 📊 Data Evaluation App")
# ----------------------------------------------------------------------------------------------------------------------
st.subheader("Basic template")
...
# st.subheader("Support ticket workflow")
st.markdown("""
...
st.subheader(" :bar_chart: Interactive data explorer")
...
st.divider()
# ----------------------------------------------------------------------------------------------------------------------
st.header("LLM and ML apps")
# ----------------------------------------------------------------------------------------------------------------------

st.subheader(" :robot_face: ML model builder")
st.markdown("""
